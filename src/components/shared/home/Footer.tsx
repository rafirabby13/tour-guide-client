...
const Footer = () => {
  return (
    <footer className="bg-primary/70  relative overflow-hidden pt-20 pb-10">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16 border-b border-slate-800 pb-12">
            ...
            <div className="flex items-center gap-3">
              <div className="p-2 bg-primary/10 rounded-lg">
                <Link href="/" className="flex items-center gap-2 group">
                  <div className="bg-white p-1.5 rounded-lg group-hover:bg-primary/20 transition-colors">
                    <svg
                  ...
                  {/* <span className="font-bold text-xl tracking-tight text-white">GuideNest</span> */}
                </Link>
              </div>
              <span className="font-bold text-3xl text-white tracking-tight">GuideNest</span>
            </div>
            <p className="text-white max-w-md leading-relaxed text-lg">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700">
            ...
            <p className="text-white mb-6 text-sm">Get the latest travel tips, hidden gems, and exclusive deals sent to your inbox.</p>

            <form className="relative">
              <Mail className="absolute left-4 top-3.5 h-5 w-5 text-white" />
              <input
                type="email"
                placeholder="Enter your email address"
                className="w-full bg-slate-900 border border-slate-700 text-white pl-12 pr-32 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all placeholder:text-white"
              />
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white">
